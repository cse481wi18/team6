...
namespace recycle {
  ...
  PointCloudC::Ptr Cropper::Crop(const PointCloudC::Ptr cloud, bool classify) {
    ...
    if (classify) {
        ...
        ros::param::param("crop_min_y_add", min_y, -0.3);
        ros::param::param("crop_min_z_add", min_z, 0.6);

        ros::param::param("crop_max_x_add", max_x, 0.9);
        ros::param::param("crop_max_y_add", max_y, 0.3);
        ros::param::param("crop_max_z_add", max_z, 1.0);
    }
